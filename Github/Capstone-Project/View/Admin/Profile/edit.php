...
<div id="app" v-cloak>
    ...
    <main class="transition-all duration-300 ease-in-out mt-14 px-6 py-10" :class="{'lg:ml-64': sidebarOpen}">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-400 text-sm mt-1">Manage your profile and security</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center h-fit">
                <div class="relative group mb-4">
                    <img :src="previewImage || user.image || 'https://ui-avatars.com/api/?name=Admin&background=e5e7eb&color=374151'" class="w-28 h-28 rounded-full object-cover border-4 border-gray-50 shadow-sm" @error="handleImageError">
                    <label class="absolute bottom-0 right-0 bg-emerald-500 text-white p-2 rounded-full cursor-pointer hover:bg-emerald-600 shadow-lg transition transform hover:scale-105">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        <input type="file" ref="fileInput" @change="handleFileUpload" accept="image/*" class="hidden">
                    </label>
                </div>
                <h3 class="font-bold text-gray-800 text-lg">{{ form.full_name || 'Admin User' }}</h3>
                <p class="text-sm text-gray-400 mt-1">{{ form.email }}</p>
                <span class="mt-3 inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-red-50 text-red-600 border border-red-100">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <form @submit.prevent="updateProfile">
                    <h3 class="text-base font-bold text-gray-800 mb-5">Personal Information</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">Full Name</label>
                            <input v-model="form.full_name" type="text" required class="w-full px-4 py-3.5 rounded-xl border border-gray-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all bg-gray-50/50 hover:bg-white focus:bg-white text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input v-model="form.username" type="text" disabled class="w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-100 text-gray-500 cursor-not-allowed text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">Phone</label>
                            <input v-model="form.phone" type="text" oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="w-full px-4 py-3.5 rounded-xl border border-gray-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all bg-gray-50/50 hover:bg-white focus:bg-white text-sm">
                        </div>
                    </div>

                    <div class="pt-5 border-t border-gray-100">
                        <h3 class="text-base font-bold text-gray-800 mb-5">Security</h3>
                        <div>
                            ...
                            <input v-model="form.password" type="password" placeholder="Leave blank to keep current" class="w-full px-4 py-3.5 rounded-xl border border-gray-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all bg-gray-50/50 hover:bg-white focus:bg-white text-sm">
                        </div>
                    </div>

                    <div class="flex justify-end pt-6">
                        <button type="submit" class="bg-emerald-500 hover:bg-emerald-600 text-white px-5 py-2.5 rounded-xl font-semibold shadow-md shadow-emerald-500/25 hover:-translate-y-0.5 transition-all flex items-center gap-2">
